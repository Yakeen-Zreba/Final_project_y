...
public class EditPassword extends AppCompatActivity {
    ...
    Button btn_save;
    ImageView back_to_profile_page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*back_to_profile_page=(ImageView) findViewById(R.id.back_to_profile_page);
        back_to_profile_page.setOnClickListener(new View.OnClickListener() {
            @Override
