...
public class AssignmentActivity extends AppCompatActivity implements FilesDataAdapter.SelectedItem{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }else
        {
            ...
            title = findViewById(R.id.assignment_title_tv);
            RecyclerView recyclerView = findViewById(R.id.assignment_files_rv);
    ...
    private void GrabAssignmentAndFiles() {
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(GET, ASSIGNMENTS_URL + "/" + id, null, response -> {
